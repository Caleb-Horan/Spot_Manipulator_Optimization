...
static size_t _ListGraph_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_spot_msgs__srv__ListGraph_Request(
    full_bounded, 0);
}
...
static size_t _ListGraph_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_spot_msgs__srv__ListGraph_Response(
    full_bounded, 0);
}
