...
static size_t _Dock_Request__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_spot_msgs__srv__Dock_Request(
    full_bounded, 0);
}
...
static size_t _Dock_Response__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_spot_msgs__srv__Dock_Response(
    full_bounded, 0);
}
