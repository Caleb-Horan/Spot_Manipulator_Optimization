...
{
  return max_serialized_size_spot_msgs__action__Trajectory_Goal(
    full_bounded, 0);
}
...
{
  return max_serialized_size_spot_msgs__action__Trajectory_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_spot_msgs__action__Trajectory_Feedback(
    full_bounded, 0);
}
...
{
  return max_serialized_size_spot_msgs__action__Trajectory_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_spot_msgs__action__Trajectory_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_spot_msgs__action__Trajectory_GetResult_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_spot_msgs__action__Trajectory_GetResult_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_spot_msgs__action__Trajectory_FeedbackMessage(
    full_bounded, 0);
}
