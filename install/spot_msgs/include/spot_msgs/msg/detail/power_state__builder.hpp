...
class Init_PowerState_stamp
{
public:
  Init_PowerState_stamp()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_PowerState_motor_power_state stamp(::spot_msgs::msg::PowerState::_stamp_type arg)
  {
...
{
  return spot_msgs::msg::builder::Init_PowerState_stamp();
}
