...
{
  spot_msgs__action__Trajectory_Goal * msg = (spot_msgs__action__Trajectory_Goal *)malloc(sizeof(spot_msgs__action__Trajectory_Goal));
  if (!msg) {
    return NULL;
  }
...
spot_msgs__action__Trajectory_Goal__Sequence__init(spot_msgs__action__Trajectory_Goal__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (spot_msgs__action__Trajectory_Goal *)calloc(size, sizeof(spot_msgs__action__Trajectory_Goal));
    if (!data) {
      return false;
    }
...
{
  spot_msgs__action__Trajectory_Goal__Sequence * array = (spot_msgs__action__Trajectory_Goal__Sequence *)malloc(sizeof(spot_msgs__action__Trajectory_Goal__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  spot_msgs__action__Trajectory_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    spot_msgs__action__Trajectory_Goal * data =
      (spot_msgs__action__Trajectory_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__action__Trajectory_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          spot_msgs__action__Trajectory_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  spot_msgs__action__Trajectory_Result * msg = (spot_msgs__action__Trajectory_Result *)malloc(sizeof(spot_msgs__action__Trajectory_Result));
  if (!msg) {
    return NULL;
  }
...
spot_msgs__action__Trajectory_Result__Sequence__init(spot_msgs__action__Trajectory_Result__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (spot_msgs__action__Trajectory_Result *)calloc(size, sizeof(spot_msgs__action__Trajectory_Result));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  spot_msgs__action__Trajectory_Result__Sequence * array = (spot_msgs__action__Trajectory_Result__Sequence *)malloc(sizeof(spot_msgs__action__Trajectory_Result__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  spot_msgs__action__Trajectory_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    spot_msgs__action__Trajectory_Result * data =
      (spot_msgs__action__Trajectory_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__action__Trajectory_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          spot_msgs__action__Trajectory_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  spot_msgs__action__Trajectory_Feedback * msg = (spot_msgs__action__Trajectory_Feedback *)malloc(sizeof(spot_msgs__action__Trajectory_Feedback));
  if (!msg) {
    return NULL;
  }
...
spot_msgs__action__Trajectory_Feedback__Sequence__init(spot_msgs__action__Trajectory_Feedback__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (spot_msgs__action__Trajectory_Feedback *)calloc(size, sizeof(spot_msgs__action__Trajectory_Feedback));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  spot_msgs__action__Trajectory_Feedback__Sequence * array = (spot_msgs__action__Trajectory_Feedback__Sequence *)malloc(sizeof(spot_msgs__action__Trajectory_Feedback__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  spot_msgs__action__Trajectory_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    spot_msgs__action__Trajectory_Feedback * data =
      (spot_msgs__action__Trajectory_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__action__Trajectory_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          spot_msgs__action__Trajectory_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  spot_msgs__action__Trajectory_SendGoal_Request * msg = (spot_msgs__action__Trajectory_SendGoal_Request *)malloc(sizeof(spot_msgs__action__Trajectory_SendGoal_Request));
  if (!msg) {
    return NULL;
  }
...
spot_msgs__action__Trajectory_SendGoal_Request__Sequence__init(spot_msgs__action__Trajectory_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (spot_msgs__action__Trajectory_SendGoal_Request *)calloc(size, sizeof(spot_msgs__action__Trajectory_SendGoal_Request));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  spot_msgs__action__Trajectory_SendGoal_Request__Sequence * array = (spot_msgs__action__Trajectory_SendGoal_Request__Sequence *)malloc(sizeof(spot_msgs__action__Trajectory_SendGoal_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  spot_msgs__action__Trajectory_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    spot_msgs__action__Trajectory_SendGoal_Request * data =
      (spot_msgs__action__Trajectory_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__action__Trajectory_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          spot_msgs__action__Trajectory_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  spot_msgs__action__Trajectory_SendGoal_Response * msg = (spot_msgs__action__Trajectory_SendGoal_Response *)malloc(sizeof(spot_msgs__action__Trajectory_SendGoal_Response));
  if (!msg) {
    return NULL;
  }
...
spot_msgs__action__Trajectory_SendGoal_Response__Sequence__init(spot_msgs__action__Trajectory_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (spot_msgs__action__Trajectory_SendGoal_Response *)calloc(size, sizeof(spot_msgs__action__Trajectory_SendGoal_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  spot_msgs__action__Trajectory_SendGoal_Response__Sequence * array = (spot_msgs__action__Trajectory_SendGoal_Response__Sequence *)malloc(sizeof(spot_msgs__action__Trajectory_SendGoal_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  spot_msgs__action__Trajectory_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    spot_msgs__action__Trajectory_SendGoal_Response * data =
      (spot_msgs__action__Trajectory_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__action__Trajectory_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          spot_msgs__action__Trajectory_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  spot_msgs__action__Trajectory_GetResult_Request * msg = (spot_msgs__action__Trajectory_GetResult_Request *)malloc(sizeof(spot_msgs__action__Trajectory_GetResult_Request));
  if (!msg) {
    return NULL;
  }
...
spot_msgs__action__Trajectory_GetResult_Request__Sequence__init(spot_msgs__action__Trajectory_GetResult_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (spot_msgs__action__Trajectory_GetResult_Request *)calloc(size, sizeof(spot_msgs__action__Trajectory_GetResult_Request));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  spot_msgs__action__Trajectory_GetResult_Request__Sequence * array = (spot_msgs__action__Trajectory_GetResult_Request__Sequence *)malloc(sizeof(spot_msgs__action__Trajectory_GetResult_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  spot_msgs__action__Trajectory_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    spot_msgs__action__Trajectory_GetResult_Request * data =
      (spot_msgs__action__Trajectory_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__action__Trajectory_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          spot_msgs__action__Trajectory_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  spot_msgs__action__Trajectory_GetResult_Response * msg = (spot_msgs__action__Trajectory_GetResult_Response *)malloc(sizeof(spot_msgs__action__Trajectory_GetResult_Response));
  if (!msg) {
    return NULL;
  }
...
spot_msgs__action__Trajectory_GetResult_Response__Sequence__init(spot_msgs__action__Trajectory_GetResult_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (spot_msgs__action__Trajectory_GetResult_Response *)calloc(size, sizeof(spot_msgs__action__Trajectory_GetResult_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  spot_msgs__action__Trajectory_GetResult_Response__Sequence * array = (spot_msgs__action__Trajectory_GetResult_Response__Sequence *)malloc(sizeof(spot_msgs__action__Trajectory_GetResult_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  spot_msgs__action__Trajectory_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    spot_msgs__action__Trajectory_GetResult_Response * data =
      (spot_msgs__action__Trajectory_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__action__Trajectory_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          spot_msgs__action__Trajectory_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  spot_msgs__action__Trajectory_FeedbackMessage * msg = (spot_msgs__action__Trajectory_FeedbackMessage *)malloc(sizeof(spot_msgs__action__Trajectory_FeedbackMessage));
  if (!msg) {
    return NULL;
  }
...
spot_msgs__action__Trajectory_FeedbackMessage__Sequence__init(spot_msgs__action__Trajectory_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (spot_msgs__action__Trajectory_FeedbackMessage *)calloc(size, sizeof(spot_msgs__action__Trajectory_FeedbackMessage));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  spot_msgs__action__Trajectory_FeedbackMessage__Sequence * array = (spot_msgs__action__Trajectory_FeedbackMessage__Sequence *)malloc(sizeof(spot_msgs__action__Trajectory_FeedbackMessage__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  spot_msgs__action__Trajectory_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    spot_msgs__action__Trajectory_FeedbackMessage * data =
      (spot_msgs__action__Trajectory_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__action__Trajectory_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          spot_msgs__action__Trajectory_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
