...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, spot_msgs, srv, SetVelocity_Request)() {
  SetVelocity_Request__rosidl_typesupport_introspection_c__SetVelocity_Request_message_member_array[0].members_ =
...
static rosidl_typesupport_introspection_c__MessageMember SetVelocity_Response__rosidl_typesupport_introspection_c__SetVelocity_Response_message_member_array[2] = {
  {
    "success",  // name
