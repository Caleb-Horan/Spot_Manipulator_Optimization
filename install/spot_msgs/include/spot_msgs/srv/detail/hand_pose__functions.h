...
#ifndef SPOT_MSGS__SRV__DETAIL__HAND_POSE__FUNCTIONS_H_
#define SPOT_MSGS__SRV__DETAIL__HAND_POSE__FUNCTIONS_H_
 ...
 * calls
 * spot_msgs__srv__HandPose_Request__init().
...
/**
 * It calls
 * spot_msgs__srv__HandPose_Request__fini()
 ...
 * spot_msgs__srv__HandPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * spot_msgs__srv__HandPose_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * spot_msgs__srv__HandPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_spot_msgs
...
/**
 * It calls
 * spot_msgs__srv__HandPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_spot_msgs
...
/**
 * It allocates the memory for the array and calls
 * spot_msgs__srv__HandPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_spot_msgs
...
/**
 * It calls
 * spot_msgs__srv__HandPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SPOT_MSGS__SRV__DETAIL__HAND_POSE__FUNCTIONS_H_
