...
{
  spot_msgs__msg__SystemFault * msg = (spot_msgs__msg__SystemFault *)malloc(sizeof(spot_msgs__msg__SystemFault));
  if (!msg) {
    return NULL;
  }
...
spot_msgs__msg__SystemFault__Sequence__init(spot_msgs__msg__SystemFault__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (spot_msgs__msg__SystemFault *)calloc(size, sizeof(spot_msgs__msg__SystemFault));
    if (!data) {
      return false;
    }
...
{
  spot_msgs__msg__SystemFault__Sequence * array = (spot_msgs__msg__SystemFault__Sequence *)malloc(sizeof(spot_msgs__msg__SystemFault__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  spot_msgs__msg__SystemFault__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    spot_msgs__msg__SystemFault * data =
      (spot_msgs__msg__SystemFault *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!spot_msgs__msg__SystemFault__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          spot_msgs__msg__SystemFault__fini(&data[i]);
        }
        free(data);
        return false;
      }
