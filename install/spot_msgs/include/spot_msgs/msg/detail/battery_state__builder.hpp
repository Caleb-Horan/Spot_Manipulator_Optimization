...
class Init_BatteryState_stamp
{
public:
  Init_BatteryState_stamp()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_BatteryState_identifier stamp(::spot_msgs::msg::BatteryState::_stamp_type arg)
  {
...
{
  return spot_msgs::msg::builder::Init_BatteryState_stamp();
}
