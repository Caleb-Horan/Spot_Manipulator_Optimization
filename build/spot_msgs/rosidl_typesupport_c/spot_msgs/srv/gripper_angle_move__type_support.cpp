...
static const _GripperAngleMove_Request_type_support_symbol_names_t _GripperAngleMove_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, srv, GripperAngleMove_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, spot_msgs, srv, GripperAngleMove_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, spot_msgs, srv, GripperAngleMove_Request)() {
  return &::spot_msgs::srv::rosidl_typesupport_c::GripperAngleMove_Request_message_type_support_handle;
}
...
static const _GripperAngleMove_Response_type_support_symbol_names_t _GripperAngleMove_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, srv, GripperAngleMove_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, spot_msgs, srv, GripperAngleMove_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_spot_msgs
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, spot_msgs, srv, GripperAngleMove_Response)() {
  return &::spot_msgs::srv::rosidl_typesupport_c::GripperAngleMove_Response_message_type_support_handle;
}
...
static const _GripperAngleMove_type_support_symbol_names_t _GripperAngleMove_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, spot_msgs, srv, GripperAngleMove)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, spot_msgs, srv, GripperAngleMove)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, spot_msgs, srv, GripperAngleMove)() {
  return &::spot_msgs::srv::rosidl_typesupport_c::GripperAngleMove_service_type_support_handle;
}
